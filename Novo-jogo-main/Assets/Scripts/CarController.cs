...
public class CarController : MonoBehaviour
{
    ...
    [SerializeField] private Transform cameraTransform; // arraste a câmera no inspector
    ...
    private void RestartPosition()
    {
        if (Input.GetKey("r"))
        {
            ...
            currentBreakForce = 10000f;
            // Zera a velocidade e rotação
            ...
            // Zera o torque dos motores
            frontLeftWheelCollider.motorTorque = 0f;
            frontRighttWheelCollider.motorTorque = 0f;
            RearLeftWheelCollider.motorTorque = 0f;
            RearRightWheelCollider.motorTorque = 0f;

            // Aplica uma força de freio gigante para garantir que pare
            currentBreakForce = 99999f;
            ApplyBreaking();
        }
    }
    ...
    // Faz a câmera olhar para o carro (posição dele)
